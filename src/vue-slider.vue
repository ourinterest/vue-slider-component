        ...
        <div v-el:elem class="vue-slider" :style="elemStyles">
            <template v-if="isMoblie">
                <template v-if="isRange">
                    <div v-el:dot0 :data-slierValue="val[0]" :data-formattedSlierValue="val[0] | numberSpaces" :class="[ tooltipStatus, 'vue-slider-tooltip-' + tooltipDirection, 'vue-slider-dot']" :style="dotStyles" @touchstart="moveStart(0)"></div>
                    <div v-el:dot1 :data-slierValue="val[1]" :data-formattedSlierValue="val[1] | numberSpaces" :class="[ tooltipStatus, 'vue-slider-tooltip-' + tooltipDirection, 'vue-slider-dot']" :style="dotStyles" @touchstart="moveStart(1)"></div>
                </template>
                <template v-else>
                    <div v-el:dot :data-slierValue="val" :data-formattedSlierValue="val | numberSpaces" :class="[ tooltipStatus, 'vue-slider-tooltip-' + tooltipDirection, 'vue-slider-dot']" :style="dotStyles" @touchstart="moveStart"></div>
                </template>
            </template>
            <template v-else>
                <template v-if="isRange">
                    <div v-el:dot0 :data-slierValue="val[0]" :data-formattedSlierValue="val[0] | numberSpaces" :class="[ tooltipStatus, 'vue-slider-tooltip-' + tooltipDirection, 'vue-slider-dot']" :style="dotStyles" @mousedown="moveStart(0)"></div>
                    <div v-el:dot1 :data-slierValue="val[1]" :data-formattedSlierValue="val[1] | numberSpaces" :class="[ tooltipStatus, 'vue-slider-tooltip-' + tooltipDirection, 'vue-slider-dot']" :style="dotStyles" @mousedown="moveStart(1)"></div>
                </template>
                <template v-else>
                    <div v-el:dot :data-slierValue="val" :data-formattedSlierValue="val | numberSpaces" :class="[ tooltipStatus, 'vue-slider-tooltip-' + tooltipDirection, 'vue-slider-dot']" :style="dotStyles" @mousedown="moveStart"></div>
                </template>
            </template>
...
.vue-slider-dot::after {
    content: attr(data-formattedSlierValue);
    display: none;
    font-size: 14px;
    white-space: nowrap;
    position: absolute;
